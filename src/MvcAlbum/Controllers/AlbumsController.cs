...
namespace MvcAlbum.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Artist,Genre,ReleaseDate,Title,Rating")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Artist,Genre,ReleaseDate,Title,Rating")] Album album)
        {
            if (id != album.ID)
            {
                return NotFound();
